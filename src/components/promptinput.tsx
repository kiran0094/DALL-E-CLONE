...
const promptinput = () => {
  ...
  const [input, setinput] = useState("")
   ...
   const { data, error, isLoading } = useSWR('/api/suggestion', fetchSuggestionfromChatGPT,{revalidateOnFocus:false})
  ...
  return (
    <div className='m-10 '>
      <form className='flex flex-col lg:flex-row shadow-md shadow-slate-400 border rounded-md lg:divide-x lg:h-16' >
        ...
        >Generate</button>
        <button className='bg-violet-500 text-white transition-colors duration-200 font-bold 
